...
The OliveTim documentation site supports the llms.txt and llms-full.txt files, available at: 

* link:https://www.olivetin.app/llms.txt[llms.txt]
* link:https://www.olivetin.app/llms-full.txt[llms-full.txt]
